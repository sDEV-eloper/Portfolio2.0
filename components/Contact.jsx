              ...
              <div className="relative  p-4 md:p-6 rounded-lg shadow-lg sm:p-12 border bg-gray-200">
                <form>
                  ...
                  <ContactInputBox
                    type="text"
                    name="email"
                    placeholder="e.g. yourmail@domain.com"
                  />
                  <ContactInputBox
                    type="text"
                    name="phone"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="border-[f0f0f0] w-full rounded-xl border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
        />
      </div>
    </>
  );
